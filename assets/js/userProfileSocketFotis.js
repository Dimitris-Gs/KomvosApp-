                        ...
                        <div class="card" style="width: 50%; margin: 0 auto;">
                            ...
                            <div class="collapse" id="collapse${result[i].arrangements[j].id}">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-6">
                                            <span class="badge bg-secondary">${result[i].listingCategoryName}</span>
                                            <div>
                                                ...
                                                &nbsp;
                                                ${ new Date(result[i].listingStartingDate).getDate()}/${ new Date(result[i].listingStartingDate).getMonth() + 1 }/${new Date(result[i].listingStartingDate).getFullYear()}
                                            </div>
                                            ...
                                            <div>
                                                ...
                                                &nbsp;
                                                ${ new Date(result[i].listingEndingDate).getDate()}/${ new Date(result[i].listingEndingDate).getMonth() + 1 }/${new Date(result[i].listingEndingDate).getFullYear()}
                                            </div>
                                            <div>
                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                                ...
                                                &nbsp;
                                                <a href="#">${result[i].arrangements[j].receiving}</a>
                                            </div>
                                        </div>
