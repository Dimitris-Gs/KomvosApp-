...
socket2.post('/receive-or-offer-listings-with-arrangements', { userType: 'offer', userId: 1 }, function (result, jwres) {
    console.log(result);
    globalDto[0] = result
})

socket2.post('/receive-or-offer-listings-with-arrangements', { userType: 'receive', userId: 1 }, function (result, jwres) {
    console.log(result);
    globalDto[1] = result
})
