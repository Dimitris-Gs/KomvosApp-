                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div>
                                                ...
                                                <!-- ${new Date(dto[i].listingStartingDate).getDate()}/${new Date(dto[i].listingStartingDate).getMonth() + 1}/${new Date(dto[i].listingStartingDate).getFullYear()} - ${new Date(dto[i].listingEndingDate).getDate()}/${new Date(dto[i].listingEndingDate).getMonth() + 1}/${new Date(dto[i].listingEndingDate).getFullYear()} -->
                                            </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-xl-3">
                      <div>
                        ...
                        &nbsp;
                        <span id="startingDate${listing.id}">${new Date(listing.listingStartingDate).toLocaleDateString("en-GB", {
        year: "numeric",
