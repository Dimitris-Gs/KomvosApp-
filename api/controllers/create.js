module.exports = {
  ...
  fn: async function (inputs) {
    await TestUser.create( { firstName: "George", lastName: "Pasparakis", email: "koukou@pasp.com", password:"a", gender:"Male", dateOfBirth: "1950-02-02",  address: "Panepistimiou 39", photo:'a', description:'a',  points: 20, employeed: 'false', disabled: 'false',volunteer: 'false',freeTime: 'false',admin: false}).fetch();
    await TestUser.create( { firstName: "George2", lastName: "Pasparakis2", email: "koukou2@pasp.com", password:"a", gender:"Male", dateOfBirth: "1950-02-02",  address: "Panepistimiou 39", photo:'a', description:'a',  points: 20, employeed: 'false', disabled: 'false',volunteer: 'false',freeTime: 'false',admin: false}).fetch();
    await TestUser.create( { firstName: "George3", lastName: "Pasparakis3", email: "koukou3@pasp.com", password:"a", gender:"Male", dateOfBirth: "1950-02-02",  address: "Panepistimiou 39", photo:'a', description:'a',  points: 20, employeed: 'false', disabled: 'false',volunteer: 'false',freeTime: 'false',admin: false}).fetch();
