module.exports = {
  ...
  fn: async function (inputs) {
    await TestUser.create( { firstName: "George", lastName: "Pasparakis", email: "koukou@pasp.com", password:"123456789", gender:"Male", dateOfBirth: "1950-02-02", radioAddress: 'true', address: "Panepistimiou 39", photo:'images/users/userDefault/image.jpg', description:'Lorem ipsum dolor sit, amet consectetur adipisicing elit. Quibusdam omnis earum laborum esse nemo, aliquam ullam delectus eaque facere quae quis quam labore maxime cumque.',  points: 20, employeed: 'false', disabled: 'false', volunteer: 'false', freeTime: 'freeTimeNone', admin: false}).fetch();

    await TestUser.create( { firstName: "Eva", lastName: "Papageorgiou", email: "skinsep@gmail.com", password:"123456789", gender:"Female", dateOfBirth: "1996-02-17", radioAddress: 'true',  address: "Panepistimiou 39", photo: 'images/users/userDefault/image.jpg', description:'Lorem ipsum dolor sit, amet consectetur adipisicing elit. Quibusdam omnis earum laborum esse nemo, aliquam ullam delectus eaque facere quae quis quam labore maxime cumque.',  points: 20, employeed: 'true', disabled: 'false', volunteer: 'true', freeTime: 'freeTimeWeekend', admin: false}).fetch();

    await TestUser.create( { firstName: "Antonis", lastName: "Markoulinos", email: "antoni@mark.com", password:"123456789", gender:"Male", dateOfBirth: "1983-07-02", radioAddress: 'false', photo: 'images/users/userDefault/image.jpg', description:'Lorem ipsum dolor sit, amet consectetur adipisicing elit. Quibusdam omnis earum laborum esse nemo, aliquam ullam delectus eaque facere quae quis quam labore maxime cumque.',  points: 20, employeed: 'false', disabled: 'false',volunteer: 'false',freeTime: 'freeTimeMinimum',admin: false}).fetch();
   
    await TestUser.create( { firstName: "John", lastName: "Papajohn", email: "john@papajohn.com", password:"123456789", gender:"Male", dateOfBirth: "1990-07-02", radioAddress: 'false', photo:'images/users/userDefault/image.jpg', description:'Lorem ipsum dolor sit, amet consectetur adipisicing elit. Quibusdam omnis earum laborum esse nemo, aliquam ullam delectus eaque facere quae quis quam labore maxime cumque.',  points: 20, employeed: 'false', disabled: 'false',volunteer: 'false',freeTime: 'freeTimeMinimum',admin: false}).fetch();
   
    await TestUser.create( { firstName: "Admin", lastName: "Admin", email: "admin@admin.com", password:"123456789", gender:"Male", dateOfBirth: "1990-07-02", radioAddress: 'false', photo:'images/users/userDefault/image.jpg', description:'Lorem ipsum dolor sit, amet consectetur adipisicing elit. Quibusdam omnis earum laborum esse nemo, aliquam ullam delectus eaque facere quae quis quam labore maxime cumque.',  points: 20, employeed: 'false', disabled: 'false',volunteer: 'false',freeTime: 'freeTimeMinimum',admin: true}).fetch();
