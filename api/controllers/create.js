module.exports = {
  ...
  fn: async function (inputs) {
      await TestUser.create( { firstName: "George", lastName: "Pasparakis", email: "koukou@pasp.com", password:"a", gender:"Male", dateOfBirth: "1950-02-02", radioAddress: 'true', address: "Panepistimiou 39", photo:'a', description:'Lorem ipsum dolor sit, amet consectetur adipisicing elit. Quibusdam omnis earum laborum esse nemo, aliquam ullam delectus eaque facere quae quis quam labore maxime cumque.',  points: 20, employeed: 'false', disabled: 'false', volunteer: 'false', freeTime: 'freeTimeNone', admin: false}).fetch();

      await TestUser.create( { firstName: "Eva", lastName: "Papageorgiou", email: "skinsep@gmail.com", password:"a", gender:"Female", dateOfBirth: "1996-02-17", radioAddress: 'true',  address: "Panepistimiou 39", photo:'a', description:'Lorem ipsum dolor sit, amet consectetur adipisicing elit. Quibusdam omnis earum laborum esse nemo, aliquam ullam delectus eaque facere quae quis quam labore maxime cumque.',  points: 20, employeed: 'true', disabled: 'false', volunteer: 'true', freeTime: 'freeTimeWeekend', admin: false}).fetch();

      await TestUser.create( { firstName: "Antonis", lastName: "Markoulinos", email: "antoni@mark.com", password:"a", gender:"Male", dateOfBirth: "1980-07-02", radioAddress: 'false', photo:'a', description:'Lorem ipsum dolor sit, amet consectetur adipisicing elit. Quibusdam omnis earum laborum esse nemo, aliquam ullam delectus eaque facere quae quis quam labore maxime cumque.',  points: 20, employeed: 'false', disabled: 'false',volunteer: 'false',freeTime: 'freeTimeMinimum',admin: false}).fetch();

      await TestUser.create( { firstName: "John", lastName: "Papajohn", email: "john@papajohn.com", password:"a", gender:"Male", dateOfBirth: "1990-07-02", radioAddress: 'false', photo:'a', description:'Lorem ipsum dolor sit, amet consectetur adipisicing elit. Quibusdam omnis earum laborum esse nemo, aliquam ullam delectus eaque facere quae quis quam labore maxime cumque.',  points: 20, employeed: 'false', disabled: 'false',volunteer: 'false',freeTime: 'freeTimeMinimum',admin: false}).fetch();
    ...
    // await Listing.create({ user_id: 1, category_id: 2, name: 'test', description: 'test', startingDate: "2022-02-02", endingDate: "2022-02-03", isOffered: true }).fetch();
    ...
    // await Arrangement.create({ offering_user_id: 1, receiving_user_id: 2, listing_id: 1, pointsOfTransaction: 1, status: 'canceled' }).fetch();
    ...
    // await Arrangement.create({ offering_user_id: 1, receiving_user_id: 2, listing_id: 2, pointsOfTransaction: 1, status: 'accepted' }).fetch();
